...
#define CHOWMEIN_CONGA_DIE_TIMEOUT 500

#define CHOWMEIN_CONGA_STATE_WALKING 100
#define CHOWMEIN_CONGA_STATE_DIE 200

#define ID_ANI_CHOWMEIN_CONGA_IDLE 1000
#define ID_ANI_CHOWMEIN_CONGA_WALKING 1001
#define ID_ANI_CHOWMEIN_CONGA_DIE 1002
